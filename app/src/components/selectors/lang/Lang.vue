...
<template>
  <div class="dropdown dropdown-end">
    ...
    <ul tabindex="0" class="dropdown-content font-bold menu bg-base-100 rounded-md w-24 mt-1 z-[1] p-2 shadow-lg pointer-events-none text-gray-400 cursor-not-allowed">
      <li v-for="l in langs" :key="l" @click="changeLang(l)">
        <a class="flex items-center gap-2 blur-sm">
