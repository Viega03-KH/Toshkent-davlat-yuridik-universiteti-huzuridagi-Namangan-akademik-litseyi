<template>
    <form action="https://fabform.io/f/xxxxx" method="post">
            ...
            <div class="mx-auto">
                <div class="grid lg:grid-cols-2 grid-cols-1">
                    <div class="lg:mb-0 mb-10">
                        <div class="group w-full h-full">
                            <div class="relative h-full">
                                <img src="https://admin-namal.tsul.uz/files/foto/1732007860/9455ac72e71cd593030a62032debc6e7.jpg"
                                    alt="ContactUs tailwind section"
                                    class="w-full h-full object-cover lg:rounded-l-2xl rounded-2xl bg-blend-multiply bg-indigo-700" />
                                <h1
                                ...
                                <div class="absolute bottom-0 w-full lg:p-11 p-5">
                                    <div class="bg-white rounded-lg p-6 block">
                                        <a href="javascript:;" class="flex items-center mb-6">
                                            ...
                                            <h5 class="text-black text-base font-normal leading-6 ml-5">470-601-1911
                                            </h5>
                                        </a>
                                        ...
                                        <a href="javascript:;" class="flex items-center">
                                            ...
                                            <h5 class="text-black text-base font-normal leading-6 ml-5">654 Sycamore
                                                Avenue, Meadowville, WA 76543</h5>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
                        <h2 class="text-indigo-600 font-manrope text-4xl font-semibold leading-10">Send Us A
                            Message</h2>
                        <input type="text"
        ...
        <p class="leading-relaxed text-xl text-gray-900 mt-8">
            We use VeilMail.io to <a class="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                href="https://veilmail.io">hide email address from spammers</a>
        </p>
    </form>
</template>